      ...
      <div className="flex flex-col gap-8">
        {educationData.map((edu, index) => (
          <div key={index} className="group relative pl-8">
            ...
            {/* Item content */}
            <div className="flex flex-col gap-2 transition-all duration-300 ease-out group-hover:-translate-y-1.5 group-hover:shadow-lg group-hover:shadow-slate-800/20 group-hover:border-slate-500 rounded-xl border-2 border-transparent p-4">
